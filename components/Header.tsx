...
const Header: React.FC = () => {
  return (
    <header className="text-center space-y-4 pt-8">
      ...
      <h1 className="text-4xl md:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-700 to-indigo-800">
        ANTREAN SERVICE OFFICER
      </h1>
      <p className="text-slate-500 text-lg md:text-xl font-medium">
        BPJS Kesehatan Kantor Cabang Jember
      </p>
    </header>
  );
};
